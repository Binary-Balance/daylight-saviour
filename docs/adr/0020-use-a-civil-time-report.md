...
- Ordinary secondary copy is selected locally and deterministically per Home Time Zone day; event copy may remain stable for its phase.
- Change Reminder taps open the applicable event phase and expose more useful detail than the notification preview.
- No daily promotional notifications, streaks, points, badges, fake milestones, engagement scoring, runtime AI, or withheld information are introduced.
- Compact event explanation, calendar export, widgets, and local share cards remain post-MVP candidates requiring separate scope decisions.
- Product success emphasizes trustworthy seasonal return and utility, not daily-active-user optimization.
