...
- Private credentials remain in Azure Key Vault; workload identity federation avoids long-lived cloud credentials where supported. Neither repository stores secret values.
