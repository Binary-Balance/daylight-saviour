...
Optional FCM settings contain identifiers only. Keyless runtime flow, setting
names, least-privilege grants, and controlled proof boundary are documented in
